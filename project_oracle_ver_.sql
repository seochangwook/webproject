...
--    2. 입력 필수 데이터는 not null로 설정. (PK랑은 별도 지정 가능)
--    3. 교수테이블에서 학과번호에 대한 null 허용은 학과가 지정되지 않은 교수가 존재하는 경우 고려.
--    4. 트랜잭션 당 COMMIT 처리함을 원칙으로 하고, 예외상황(EXCEPTION)이면 ROLLBACK을 수행한다.
...
--    8. 패키지는 사용하지 않는다.
--    9. 최대학점은 9학점으로 제한한다.
--   10. 프로시저에 대한 디버깅은 DBMS_OUTPUT.PUT_LINE()을 이용한다.
-------------------------------------------
--# 학생테이블
...
INSERT INTO student(STU_ID, STU_NAME, STU_PASSWORD, STU_BIRTH, STU_NUMBER, STU_ADDRESS, STU_DEPTNO, STU_GRADE, STU_EMAIL, STU_PHONENUMBER, STU_PHOTO)
VALUES ('dfg345', '이지영', 'dfgh4567', '89/05/15', '201204545', '서울시 마포구', '3', '3', 'sdf43@lotte.net', '01084516853', 'lee.png');
INSERT INTO student(STU_ID, STU_NAME, STU_PASSWORD, STU_BIRTH, STU_NUMBER, STU_ADDRESS, STU_DEPTNO, STU_GRADE, STU_EMAIL, STU_PHONENUMBER, STU_PHOTO) 
VALUES ('hjk678', '최지호', 'jffrtr674', '91/06/22', '201384596', '서울시 구로구', '4', '4', 'sdtet@lotte.net', '01078459865', 'choi.png');
INSERT INTO student(STU_ID, STU_NAME, STU_PASSWORD, STU_BIRTH, STU_NUMBER, STU_ADDRESS, STU_DEPTNO, STU_GRADE, STU_EMAIL, STU_PHONENUMBER, STU_PHOTO) 
VALUES ('vdsf879', '김지욱', 'ggfhh98', '90/12/15', '201248562', '서울시 노원구', '5', '2', 'sdas@lotte.net', '01085489632', 'kim.png');
INSERT INTO student(STU_ID, STU_NAME, STU_PASSWORD, STU_BIRTH, STU_NUMBER, STU_ADDRESS, STU_DEPTNO, STU_GRADE, STU_EMAIL, STU_PHONENUMBER, STU_PHOTO) 
VALUES ('dff786', '최경준', 'dfsdf45', '89/11/15', '201575656', '청주시 흥덕구', '7', '4', 'ertreds@lotte.net', '01075896521', 'leej.png');
INSERT INTO student(STU_ID, STU_NAME, STU_PASSWORD, STU_BIRTH, STU_NUMBER, STU_ADDRESS, STU_DEPTNO, STU_GRADE, STU_EMAIL, STU_PHONENUMBER, STU_PHOTO) 
VALUES ('wsx356', '이진아', 'fgdfg5435', '90/11/18', '201575955', '청주시 오송읍', '6', '3', 'serwer@lotte.net', '01035789652', 'lees.png');
INSERT INTO student(STU_ID, STU_NAME, STU_PASSWORD, STU_BIRTH, STU_NUMBER, STU_ADDRESS, STU_DEPTNO, STU_GRADE, STU_EMAIL, STU_PHONENUMBER, STU_PHOTO) 
VALUES ('tgvfd66', '임소영', 'dfsd564', '91/04/08', '201358524', '경기도 광명', '8', '4', 'fgfgr@lotte.net', '01087954896', 'lim.png');
INSERT INTO student(STU_ID, STU_NAME, STU_PASSWORD, STU_BIRTH, STU_NUMBER, STU_ADDRESS, STU_DEPTNO, STU_GRADE, STU_EMAIL, STU_PHONENUMBER, STU_PHOTO) 
VALUES ('fgh78', '장은주', 'sdfsd675', '92/07/11', '201295178', '경기도 광주', '9', '2', 'dsfdsd@lotte.net', '01058254236', 'jang.png');
INSERT INTO student(STU_ID, STU_NAME, STU_PASSWORD, STU_BIRTH, STU_NUMBER, STU_ADDRESS, STU_DEPTNO, STU_GRADE, STU_EMAIL, STU_PHONENUMBER, STU_PHOTO) 
VALUES ('tggf68', '김진아', '944465456sd', '89/11/15', '201114576', '서울시 아현동', '10', '3', 'rfhf@lotte.net', '01034685432', 'jj.png');
INSERT INTO student(STU_ID, STU_NAME, STU_PASSWORD, STU_BIRTH, STU_NUMBER, STU_ADDRESS, STU_DEPTNO, STU_GRADE, STU_EMAIL, STU_PHONENUMBER, STU_PHOTO) 
VALUES ('sdfyt79', '강건주', '46452132sdds', '90/11/17', '201245798', '서울시 정자동', '11', '4', 'rdfh@lotte.net', '01024579086', 'jjh.png');
INSERT INTO student(STU_ID, STU_NAME, STU_PASSWORD, STU_BIRTH, STU_NUMBER, STU_ADDRESS, STU_DEPTNO, STU_GRADE, STU_EMAIL, STU_PHONENUMBER, STU_PHOTO) 
VALUES ('gre456', '강은영', '646843201rg', '91/11/16', '201489563', '서울시 공덕동', '12', '2', 'ugds@lotte.net', '01087534686', 'sfwf.png');
INSERT INTO student(STU_ID, STU_NAME, STU_PASSWORD, STU_BIRTH, STU_NUMBER, STU_ADDRESS, STU_DEPTNO, STU_GRADE, STU_EMAIL, STU_PHONENUMBER, STU_PHOTO) 
VALUES ('ujgd65', '백희원', '5416313sw', '90/11/17', '201145789', '서울시 북아현동', '13', '3', 'jhfd@lotte.net', '01075489631', 'baek.png');
INSERT INTO student(STU_ID, STU_NAME, STU_PASSWORD, STU_BIRTH, STU_NUMBER, STU_ADDRESS, STU_DEPTNO, STU_GRADE, STU_EMAIL, STU_PHONENUMBER, STU_PHOTO) 
VALUES ('qwqe5645', '남궁준', 'sdaf74275', '91/05/22', '20138781', '서울시 중계1동', '14', '4', 'rthrt@lotte.net', '01084346711', 'nam.png');
INSERT INTO student(STU_ID, STU_NAME, STU_PASSWORD, STU_BIRTH, STU_NUMBER, STU_ADDRESS, STU_DEPTNO, STU_GRADE, STU_EMAIL, STU_PHONENUMBER, STU_PHOTO) 
VALUES ('regg70', '심준섭', '56541654s', '91/06/08', '201487655', '서울시 중계2동', '15', '2', 'yhgfg@lotte.net', '01050407984', 'shim.png');
INSERT INTO student(STU_ID, STU_NAME, STU_PASSWORD, STU_BIRTH, STU_NUMBER, STU_ADDRESS, STU_DEPTNO, STU_GRADE, STU_EMAIL, STU_PHONENUMBER, STU_PHOTO) 
VALUES ('sdf45', '장은지', '454444defe', '91/11/15', '201575389', '서울시 중계3동', '16', '3', 'efgb@lotte.net', '01045068905', 'jang.png');
INSERT INTO student(STU_ID, STU_NAME, STU_PASSWORD, STU_BIRTH, STU_NUMBER, STU_ADDRESS, STU_DEPTNO, STU_GRADE, STU_EMAIL, STU_PHONENUMBER, STU_PHOTO) 
VALUES ('htyh567', '김건우', '1532326se', '92/07/05', '201678425', '서울시 중계4동', '17', '1', 'uhgf@lotte.net', '01070567891', 'kwoo.png');
...
-------------------------------------------
--# 로그인 관련 프로시저
--$ 기능 : 로그인 유효성 검사, 아이디 중복검사, 학생등록, 학생정보 수정 
...
--* 프로시저 실행 (OUT변수 반환)
SET SERVEROUTPUT ON -- dbms_output이 가능하게 해주는 설정
DECLARE
  retval number; -- out변수
BEGIN
  ...
  PRO_LOGIN_ENROLL(1, 'scw0531', '서창욱','tjckd246!','92/04/06',201158102,'경기도 수원시',1,4,'scw05313315@gmail.com','01042084757','seopicture.png', retval); -- 학생정보 수정
...
v_get_grade number(2) := 0; -- 계산을 하기위해 초기값을 0으로 선언.
v_c_number number(2);
BEGIN
  IF in_pro_type = 1 THEN
    -- 신청
    -- 1단계 : 수강신청 과목에 대한 시간 유효성 검사
    ...
    IF v_count_row = 0 THEN
      -- 2단계 : 총 학점 유효성 검사
      OPEN course_grade_check; -- 커서 오픈
      LOOP
        FETCH course_grade_check INTO v_c_number, v_total_grade;
          EXIT  WHEN  course_grade_check%NOTFOUND; -- 커서의 종료조건
          v_get_grade := v_get_grade + v_total_grade; -- 커서를 돌면서 학점을 계산
      END  LOOP;
      CLOSE course_grade_check; -- 커서 종료
      -- 최대 수강가능 학점은 9학점.
...
DECLARE
  retval number; -- out변수
BEGIN
  --PRO_COURSE_MANAGE(3,201158102, 14, 'good course',  retval); -- 메모기능
  PRO_COURSE_MANAGE(1,201158102, 14, ' ',  retval); -- 수강신청 경우
  DBMS_OUTPUT.PUT_LINE('return value: '||retval);
END;
-------------------------------------------
--# 나의 수강신청 목록 출력
